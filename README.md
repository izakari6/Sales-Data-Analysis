...
7.   Purchase Address - The purchase order is prepared by the buyer, often through a purchasing department. The purchase order, or PO, usually includes a PO number, which is useful in matching shipments with purchases; a shipping date; billing address; shipping address; and the request items, quantities and price.
 ...
 # Data Preparation (Data Clean)
 One of the impotant steps in preparing data for analysis is makinng sure that the data set is well clean and fit for the purpose of the analysis. As much as data cleaning is time consuming, it is prudent that careful attention is given to it or else the final result of the ananlysis will be misleading.
 
 In this project, the dataset was not that messy. To get this dataset into best shape, these activities were carried out.
...
# Visual Analysis
One of the purposes of visual analysis is to create a summary for the important fact about a dataset. It is much easier to read and understand a well visualized data than trying to read a raw dataset with multiple columns and rows. The aims of this project was achieved with the help of visualizations in the form of bar charts and line plots.

# Findings
1. 2019 had the highest sales revenue ($ 34,456,867.65) as compared to 2020 with ($ 8,670.29) and this was due to the inavalability of the entire sales transactions of 2020.
2. December, October and October were the top 3 selling month with a sales revenue of ($4,608,295.70 ,$3,734,777.86 , $3,389,217.98 respectively)
